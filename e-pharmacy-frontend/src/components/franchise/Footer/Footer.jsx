    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <nav className={styles.links}>
          <Link to="/franchise/shop" className={styles.navLink}>Shop</Link>
          <Link to="/medicine/all" className={styles.navLink}>Medicine</Link>
          <Link to="/franchise/statistics" className={styles.navLink}>Statistics</Link>
        </nav>
      </div>
