      ...
      <div className={styles.container}>
        ...
        {isAuth && (
          <nav className={styles.nav}>
            <NavLink to="/shop" className={({ isActive }) => `${styles.link} ${isActive ? styles.active : ''}`}>Shop</NavLink>
            <NavLink to="/medicine/all" className={({ isActive }) => `${styles.link} ${isActive ? styles.active : ''}`}>Medicine</NavLink>
            <NavLink to="/statistics" className={({ isActive }) => `${styles.link} ${isActive ? styles.active : ''}`}>Statistics</NavLink>
