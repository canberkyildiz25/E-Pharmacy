    ...
    <header className={styles.header}>
      <div className={styles.container}>
        ...
        <nav className={styles.nav}>
          <NavLink to="/home" className={({ isActive }) => `${styles.link} ${isActive ? styles.active : ''}`}>Home</NavLink>
          <NavLink to="/medicine-store" className={({ isActive }) => `${styles.link} ${isActive ? styles.active : ''}`}>Medicine store</NavLink>
          <NavLink to="/medicine" className={({ isActive }) => `${styles.link} ${isActive ? styles.active : ''}`}>Medicine</NavLink>
        </nav>
