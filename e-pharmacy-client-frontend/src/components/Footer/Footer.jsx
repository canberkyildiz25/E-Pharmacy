      ...
      <div className={styles.container}>
        <div className={styles.top}>
          <div className={styles.brand}>
            ...
            <p className={styles.tagline}>Get the medicine to help you feel better, get back to your active life, and enjoy every moment</p>
          ...
          <nav className={styles.nav}>
            ...
            <NavLink to="/medicine" className={styles.navLink}>Medicine</NavLink>
          </nav>
        </div>

        <div className={styles.bottom}>
          <p className={styles.copy}>© E-Pharmacy 2023. All Rights Reserved</p>
